...
const items = ref([
  ...
  },
  {
    ...
    command: () => addQuads([quad(subject, predicate, shui.value.toSTerm(literal('', 'en')), graph)])
  },
  {
  ...
  <Card>
    <template #title
      ...
      <div class="space-y-4 pt-4">
        ...
        <Button icon="pi pi-plus" aria-label="Add new" aria-haspopup="true" :aria-controls="overlayMenuId" @click="addToggle" />
